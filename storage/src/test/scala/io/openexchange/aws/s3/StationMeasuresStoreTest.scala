...
class StationMeasuresStoreTest extends AnyFlatSpec with MockFactory with Matchers {

  private val amazonS3Mock = mock[AmazonS3]
  private val s3Client = new S3Client(amazonS3Mock)
  private val stationStore = S3StationMeasuresStore(s3Client, "testBucket", "testKey")
